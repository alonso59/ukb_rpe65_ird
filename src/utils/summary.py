...
def summary(model, input_size, logger, batch_size=-1, device="cuda", ):
    ...
    logger.info("==========================================================================")
    line_new = "{:>20}  {:>15} {:>15} {:>15}".format("Layer (type)", "Input Shape", "Output Shape", "Param #")
    ...
    for layer in summary:
        ...
        line_new = "{:>20}  {:>15} {:>15} {:>15}".format(
            layer,
            str(summary[layer]["input_shape"][1:]),
            str(summary[layer]["output_shape"][1:]),
