...
class R2U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1,t=2):
        ...
        self.RRCNN5 = RRCNN_block(ch_in=128,ch_out=128,t=t)
        

        self.Up5 = up_conv(ch_in=128,ch_out=64)
        self.Up_RRCNN5 = RRCNN_block(ch_in=192, ch_out=64,t=t)
        
        self.Up4 = up_conv(ch_in=64,ch_out=32)
        self.Up_RRCNN4 = RRCNN_block(ch_in=96, ch_out=32,t=t)
        
        self.Up3 = up_conv(ch_in=32,ch_out=16)
        self.Up_RRCNN3 = RRCNN_block(ch_in=48, ch_out=16,t=t)
        
        self.Up2 = up_conv(ch_in=16,ch_out=8)
        self.Up_RRCNN2 = RRCNN_block(ch_in=24, ch_out=8,t=t)
